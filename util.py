        ...
        for i, (train, t) in enumerate(order):
            if v_station.endswith("_"):  # only consider dp dd pd pp
                if train.v_sta_type[v_station] == "s":
                    # dd
                    model.addConstrs(
                        (theta_dd[station][train][train_after] == 1 for train_after, t_after in order[i:]
                    ...
                    # dp
                    model.addConstrs(
                        (theta_dp[station][train][train_after] == 1 for train_after, t_after in order[i:]
                    ...
                    # pd
                    model.addConstrs(
                        (theta_pd[station][train][train_after] == 1 for train_after, t_after in order[i:]
                         if train_after.v_sta_type[v_station] == "s"
                         and (train, train_after) not in overtaking_dict
                ...
                if train.v_sta_type[v_station] == "a":
                    # aa
                    model.addConstrs(
                        (theta_aa[station][train][train_after] == 1 for train_after, t_after in order[i:]
                    ...
                    # ap
                    model.addConstrs(
                        (theta_ap[station][train][train_after] == 1 for train_after, t_after in order[i:]
                         if train_after.v_sta_type[v_station] == "p"
                         and (train, train_after) not in overtaking_dict
                    ...
                    # pa
                    model.addConstrs(
                        (theta_pa[station][train][train_after] == 1 for train_after, t_after in order[i:]
                         if train_after.v_sta_type[v_station] == "a"
                         and (train, train_after) not in overtaking_dict
                    ...
                    # pp
                    model.addConstrs(
                        (theta_pp[station][train][train_after] == 1 for train_after, t_after in order[i:]
                         if train_after.v_sta_type[v_station] == "p"
                         and (train, train_after) not in overtaking_dict
